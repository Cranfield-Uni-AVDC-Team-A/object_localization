...
#include <uav_stack_msgs/BoundingBox2D>
#include <uav_stack_msgs/Detector2D>
#include <uav_stack_msgs/Detector2DArray>
#include <uav_stack_msgs/Detector3D>
#include <uav_stack_msgs/Detector3DArray>
...
#include "object_localizatino/Detector.h"
...
private:
    ...
    void drawDetections(cv::Mat &img, std::vector<Detections2D>&detections2D_array);
